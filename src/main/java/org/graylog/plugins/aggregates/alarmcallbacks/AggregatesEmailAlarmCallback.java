 ...
 */
package org.graylog.plugins.aggregates.alarmcallbacks;
...
public class AggregatesEmailAlarmCallback implements AlarmCallback {
    private static final Logger LOG = LoggerFactory.getLogger(AggregatesEmailAlarmCallback.class);

    public static final String CK_USER_RECEIVERS = "user_receivers";
    public static final String CK_EMAIL_RECEIVERS = "email_receivers";

    private final AggregatesAlertSender alertSender;
    ...
    @Inject
    public AggregatesEmailAlarmCallback(AggregatesAlertSender alertSender,
    ...
    public void call(Stream stream, AlertCondition.CheckResult result) throws AlarmCallbackException {
        ...
        if (!(alertCondition instanceof AggregatesAlertCondition)) {
            throw new AlarmCallbackException("This Alarm Callback only works in conjunction with alerts generated by the Aggregates Plugin.");
        }
    ...
    public String getName() {
        return "Aggregates Email Alert Callback";
    }
